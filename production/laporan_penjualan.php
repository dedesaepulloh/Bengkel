...
?>
        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <form method="post" action="cetak_penjualan.php">
                            ...
                            <div class="card-box table-responsive">
                              <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                                ...
                                <?php 
                                  ...
                                  $i = 0;
                                  $tampil = mysqli_query($koneksi, "SELECT * FROM tbl_penjualan_head inner join tbl_penjualan_det on tbl_penjualan_head.id_penjualan=tbl_penjualan_det.id_penjualan");
