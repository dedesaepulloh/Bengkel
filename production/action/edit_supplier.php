<?php 
  ...
  $tampil = mysqli_query($koneksi, "SELECT * FROM tbl_supplier WHERE id_supplier = $_GET[id_supplier]");
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form method = "POST" action="update_supplier.php" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="nama_supplier" name="nama_supplier" value="<?php echo "$data[nama_supplier]"; ?>" required="required" class="form-control ">
                          <input type="hidden"  name="id_supplier" value="<?php echo "$data[id_supplier]"; ?>" required="required" class="form-control ">
                        </div>
                      </div>
                      <div class="item form-group">
