                                ...
                                ?>
                                  <tr>
                                    ...
                                    <td class="project-actions text-center">
                                        <a class="btn btn-info btn-sm" href="action/edit_user.php?id_user=<?php echo "$data[id_user]"; ?>">
                                            <i class="fa fa-edit">
                                            </i>
                                            Edit
                                        </a>
                                        <a class="btn btn-danger btn-sm" href="action/delete_user.php?id_user=<?php echo "$data[id_user]"; ?>">
                                            <i class="fa fa-trash">
                                            </i>
                                            Delete
                                        </a>
    ...
    <div class="modal fade" id="modal-lg">
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                ...
                <form role="form" method="POST" action="action/insert_user.php" enctype="multipart/form-data">
                    <div class="card-body">
