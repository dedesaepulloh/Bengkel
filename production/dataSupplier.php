                          ...
                          <div class="col-sm-12">
                            <div class="card-box table-responsive">
                              <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                                ...
                                <?php 
                                  $i = 0;
                                  $tampil = mysqli_query($koneksi, "SELECT * FROM tbl_supplier");
                                ...
                                ?>
                                  <tr>
                                    ...
                                    <td class="project-actions text-center">
                                        <a class="btn btn-info btn-sm" href="action/edit_supplier.php?id_supplier=<?php echo "$data[id_supplier]"; ?>">
                                            <i class="fa fa-edit">
                                            </i>
                                            Edit
                                        </a>
                                        <a class="btn btn-danger btn-sm" href="action/delete_supplier.php?id_supplier=<?php echo "$data[id_supplier]"; ?>">
                                            <i class="fa fa-trash">
                                            </i>
                                            Delete
                                        </a>
    ...
    <div class="modal fade" id="modal-lg">
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                ...
                <form role="form" method="POST" action="action/insert_supplier.php" enctype="multipart/form-data">
                    <div class="card-body">
